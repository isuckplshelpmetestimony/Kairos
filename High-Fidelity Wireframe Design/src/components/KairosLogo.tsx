  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center">
        <svg className="w-9 h-9 md:w-10 md:h-10" viewBox="0 0 32 32" fill="none">
          {/* Cat silhouette body */}
          <path 
      ...
      <span className="font-semibold text-kairos-charcoal tracking-wide text-lg md:text-xl">Kairos</span>
    </div>
  );
}